...
// 반복문을 사용해서 el.type === "group"  갯수에 맞게 li 태그 생성
// inputBox.type = "checkbox" 만들어주기
// el.name을 span으로 감싸야한다. textContent
// 그리고 다시 ul을 만든다
// <여기까지 재귀함수로 계속 돌리기> => 무한 렌더링

// el.type === "group" 이 아닌 경우, (자식노드가 없는 경우)
// 없으면 li를 만든다.
// li.textContent 는 el.name
